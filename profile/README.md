...
🙋‍♀️🙋‍♂️ **T**iny **W**eather **F**orecast **G**ermany is a free open source app for **android** devices coded in Java and powered by open data provided by the **D**eutscher **W**etter**d**ienst (DWD) Germany's national weather agency (similar to NOAA in 🇺🇸).

One of the key features of *Kleine Wettervorschau Deutschland* (**T**iny**W**eather**F**orecast**G**ermany in 🇩🇪) is the integration with **Gadgetbridge** as a weather data provider for smart gadgets.
...
* [**javadoc**](https://tinyweatherforecastgermanygroup.gitlab.io/twfg-javadoc/) code documentation
